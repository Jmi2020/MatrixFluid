...
static void demo_task(void *arg) {
    ...
    while (g_demo.demo_active) {
        ...
        for (int cycle = 0; cycle < 2 && g_demo.demo_active; ++cycle) {
            show_demo_state(FLUID_LEVEL_FULL, "80%", LED_COLOR_GREEN);
            show_demo_state(FLUID_LEVEL_ABOVE_HALF, "60%", LED_COLOR_GREEN);
            show_demo_state(FLUID_LEVEL_BELOW_HALF, "40%", LED_COLOR_YELLOW);
            show_demo_state(FLUID_LEVEL_NEAR_EMPTY, "20%", LED_COLOR_RED);
            show_demo_state(FLUID_LEVEL_EMPTY, "0%", LED_COLOR_RED);
        }
